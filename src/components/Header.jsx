    ...
    <header className="dashboard-header">
      <div className="header-left">
        ...
        <div className="welcome-section">
          <h2 className="welcome-message">Welcome back <span className="admin-name">Admin, John Doe</span></h2>
          <p className="welcome-subtitle">Manage your investments, savings and Loans.</p>
        </div>
      </div>
